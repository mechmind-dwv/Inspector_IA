...
from .anomaly_index import IRACalculator, IRAResult, format_ira_report
...
class FraudPatternDetector:
    ...
    @staticmethod
    def detect_crypto_hiding(politician_data: Dict, graph_data: Dict) -> Dict:
        """
        ...
        for wallet in crypto_wallets:
            ...
            if wallet.get("privacy_coin_holdings", False):
                ...
                crypto_indicators.append(
                    {
                        "type": "privacy_coin",
                        "description": "Tenencia de criptomonedas de privacidad",
                        "severity": "high",
                    }
                )
            ...
            if wallet.get("cross_chain_transactions", 0) > 2:
                ...
                crypto_indicators.append(
                    {
                        "type": "cross_chain",
                        "description": "Múltiples transacciones cross-chain detectadas",
                        "severity": "medium",
                    }
                )
                ...
                crypto_indicators.append(
                    {
                        ...
                        "description": "Patrón de transacciones estructuradas detectado",
                        "severity": "critical",
                    }
                )
    ...
    @staticmethod
    def detect_offshore_laundering(politician_data: Dict, graph_data: Dict) -> Dict:
        """
                ...
                offshore_indicators.append(
                    {
                        ...
                        "description": "Múltiples cambios de jurisdicción detectados",
                        "severity": "high",
                    }
                )
    ...
    @staticmethod
    def detect_travel_coincidence(politician_data: Dict, temporal_events: List[Dict]) -> Dict:
        """
    ...
    @staticmethod
    def detect_ghost_company(politician_data: Dict, graph_data: Dict) -> Dict:
        """
    ...
    @staticmethod
    def detect_insider_trading(politician_data: Dict, temporal_events: List[Dict]) -> Dict:
        """
...
class RiskCalculator:
    ...
    def calculate_comprehensive_risk(
        ...
        completeness_scores = {
            "patrimonial": self.completeness_analyzer.analyze_patrimonial_completeness(
                politician_data
            ),
        ...
        comprehensive_result = {
            ...
            # Resumen ejecutivo
            "executive_summary": self._generate_executive_summary(ira_result, patterns_detected),
            # Reporte formateado
    ...
    def _generate_executive_summary(
        self, ira_result: IRAResult, patterns_detected: List[Dict]
    ) -> str:
